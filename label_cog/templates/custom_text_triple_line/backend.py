...
async def process_data(data):
    ...
    img3 = await asyncio.to_thread(create_image_with_text, text3, 256)
    ...
    joined_img = await asyncio.to_thread(join_images_vertically, joined_img, img3, padding_between=10)
